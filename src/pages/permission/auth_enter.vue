<template>
	<div class="w_100 h_100 flex fc">
		...
		<!-- 添加/编辑 -->
		<custom-dialog dialogWidth="640px" :dialogTitle="`${dialog_type == 'add'?'添加':'编辑'}权限`" ref="addEditDialog" @callback="addEditConfirm">
			<el-form label-position="left">
				<el-form-item label="权限名称：">
					<el-input style="width:232px" v-model="access_name"></el-input>
				</el-form-item>
				...
				<el-form-item label="权限码：">
					...
					<el-button type="success" icon="el-icon-plus" circle @click="addAccessCode"></el-button>
					<div style="margin-top: 10px;">
						<el-tag style="margin-right: 20px;margin-bottom: 10px" closable v-for="(item,index) in access_codes" :key="index" type="success" effect="dark" @close="handleClose(index)"> {{ item }}
						</el-tag>
					</div>
				</el-form-item>
